...
def __start__():
    try:
        print(Fore.RED+" [!] Admin Page Finder . . . \n")
        print(Fore.RED+" [!] Enter WebSite Address\n")
        print(Fore.RED+" [!] Enter Exit To Go To Main Menu \n")
        url = input(Fore.RED+" ┌─["+Fore.LIGHTGREEN_EX+"HAMMASTER"+Fore.BLUE+"~"+Fore.WHITE+"@HOME"+Fore.RED+"/"+Fore.CYAN+"IG"+Fore.RED+"/"+Fore.LIGHTYELLOW_EX+"Admin-Finder"+Fore.RED+"""]
 └──╼ """+Fore.WHITE+"卐 ")
