...
""").split("\n")
    print(Fore.RED+"\n [+] Wordpress . . . \n")
    print(Fore.GREEN+" [+] Enter WordPress URL\n")
    print(Fore.RED+" [!] Do Not Include Http\n")
    print(Fore.GREEN+" [!] Enter Exit To Go To Main Menu \n")
    try:
        url = input(Fore.RED+" ┌─["+Fore.LIGHTGREEN_EX+"HAMMASTER"+Fore.BLUE+"~"+Fore.WHITE+"@HOME"+Fore.RED+"/"+Fore.CYAN+"CMN"+Fore.RED+"/"+Fore.LIGHTYELLOW_EX+"WP"+Fore.RED+"/"+Fore.GREEN+"Get-Plugins"+Fore.RED+"""]
 └──╼ 卐 """).lower()
...
def user():
    try:
        ...
        print(Fore.RED+" [!] Do Not Include Http\n")
        print(Fore.GREEN+" [!] Enter Exit To Go To Main Menu \n")
        Url = input(Fore.RED+" ┌─["+Fore.LIGHTGREEN_EX+"HAMMASTER"+Fore.BLUE+"~"+Fore.WHITE+"@HOME"+Fore.RED+"/"+Fore.CYAN+"CMN"+Fore.RED+"/"+Fore.LIGHTYELLOW_EX+"WP"+Fore.RED+"/"+Fore.GREEN+"Get-Username"+Fore.RED+"""]
 └──╼ """+Fore.WHITE+"卐 ").lower()
        if Url == "exit" or Url == "Exit" or Url == "EXIT":
            try:
                return
